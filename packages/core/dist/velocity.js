...
class VelocityCalculator {
     ...
     */
    static calculateEffectiveVelocity(team, sprintCount, customModel) {
     ...
     */
    static calculateVelocityPerSprint(team, sprintCount, customModel) {
...
VelocityCalculator.DEFAULT_FOCUS_FACTOR_1_SPRINT = 0.8;
VelocityCalculator.DEFAULT_FOCUS_FACTOR_MULTI_SPRINT = 0.7;
VelocityCalculator.DEFAULT_OVERHEAD_PER_SPRINT = 0.1;
